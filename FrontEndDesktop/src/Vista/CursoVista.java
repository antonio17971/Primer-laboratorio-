 ...
 * @author Usuario1
 */
public class CursoVista extends javax.swing.JInternalFrame implements java.util.Observer{
    
    CursoControlador controller;
    CursoModel model;
    ...
    public void update(Observable o, Object arg) {
       ...
       if (model.getErrores().get("CODIGO")!=null){
        ...
        if (model.getErrores().get("CREDITOS")!=null){
            creditosFld.setBorder(Main.BORDER_ERROR);
        ...
        if (model.getErrores().get("HORAS")!=null){
            horasFld.setBorder(Main.BORDER_ERROR);
